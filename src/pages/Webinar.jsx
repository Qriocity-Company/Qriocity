...
const MainCard = () => {
  return (
    <div className="md:max-w-2xl max-w-xs text-center  md:py-20 py-10 mx-auto flex flex-col p-3 justify-center items-center border-2 border-white rounded-[42px] ">
      ...
      <p className="text-[#FBA154] md:text-xl mt-5 ">
...
const ProblemCard = ({ content, boldContent }) => {
  return (
    <div className=" max-w-lg bg-black p-8 rounded-3xl border border-white">
      ...
      {/* <div className="absolute w-[10px] h-[10px] bg-white  rounded-full top-[40%] -right-1 "></div> */}
    </div>
  );
};
    ...
    <div className="relative ">
      ...
      <div className="bg-gradient-to-b  from-[#04131300] to-[#041313] w-full ">
        <div className=" md:w-5/6 mx-auto  md:p-16 p-4">
          <div className="md:text-6xl text-2xl text-center text-white mb-10 ">
            Why Choose us?
          </div>
          <div className="bg-[#353535] rounded-xl p-10 grid lg:grid-cols-3 md:grid-cols-2 gap-10">
            <div className="max-w-xs bg-white p-5 rounded-xl ">
              <div className="text-[#F15A29] md:text-5xl text-4xl font-[700] ">
                200+
              </div>
        ...
        <div className="md:mt-20 mt-10  space-y-10 text-center md:p-16 p-4 ">
        ...
        <div className="md:mt-20 mt-10 md:p-16 p-4 ">
          <div className="md:text-6xl text-3xl text-center text-white mb-10 ">
            What problem we will solve?
          </div>
          <div className="mt-20 relative grid md:grid-cols-2  gap-x-56 gap-y-10  mx-auto ">
            <ProblemCard
            ...
            />
            <div className="md:block hidden absolute font-[500] text-white text-9xl top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] ">
              ?
            </div>
          </div>
        </div>
        ...
        <div className="md:mt-20 mt-10 text-center md:p-16 p-4 ">
          <div className="md:text-4xl  text-2xl p-2 md:p-5 px-10 md:px-20 w-fit mx-auto  rounded-full border border-white  text-center text-white mb-10 ">
            Our Project Categories
          </div>
          <div className="grid md:grid-cols-3 gap-10 place-items-center mt-20">
            {images.map((m, index) => {
              return (
        ...
        <div className="md:mt-20 mt-10 text-center ">
          <div className="md:text-6xl bg-white w-screen  text-2xl md:p-5 p-2 px-20 text-center text-black mb-10 font-[500] flex  items-center justify-center gap-5 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="64"
              height="64"
