  ...
  return (
    <div className="bg-black h-screen flex items-center justify-center">
      <div className="relative flex flex-col lg:flex-row items-center justify-between w-full p-4 ">
        <div className="relative box mt-28 lg:-m-8  p-4  bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg shadow-lg lg:w-[500px] lg:h-[450px] flex flex-col">
